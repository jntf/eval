<template>
    <div class="w-full max-w-md mx-auto sticky z-10 pt-24">
        <div class="px-5 bg-gray-800 rounded-2xl mb-5 shadow-2xl">
            <div class="flex">
                ...
                <div class="flex-auto hover:w-full group" v-if="isModalVisible == false">
                    <router-link to="rafale"
                        class="flex items-center justify-center text-center mx-auto px-4 py-2 group-hover:w-full text-red-50">
                        <span
                            class="block px-1 py-1 border border-transparent group-hover:border-red-50 rounded-full group-hover:flex-grow">
                            <i class="far fa-rocket text-2xl pt-1"></i><span
                                class="hidden group-hover:inline-block ml-3 align-bottom pb-1">Rafale</span>
                        </span>
                    </router-link>
                </div>
                <div class="flex-auto hover:w-full group" v-if="isModalVisible == false">
