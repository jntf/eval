      ...
      <!-- breadcrumb -->
          ...
          <div class="flex flex-wrap -mx-3">
            ...
            <div class="w-full xl:w-1/3 px-3">
              <p class="text-xl font-semibold text-black mb-4">Recent Sales</p>
              <!-- <div ></div> -->
              <div id="d3-target" class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0"></div>
            </div>

            <div class="w-full xl:w-1/3 px-3">
              <p class="text-xl font-semibold mb-4">Recent Reviews</p>
              <div id="reviews-chart" class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0"></div>
            </div>
...
// Get the value isOpen passed from the parent component
export default defineComponent({
  name: 'Dashboard',
  mounted() {
    d3.select("#d3-target")
      // Create a chart with the data with the id of d3-target
      // the chart have year in the x axis and sales in the y axis
      .append("svg")
      .attr("width", 600)
      .attr("height", 400)
      .append("g")
      .selectAll("rect")
      .data(Object.entries(sales))
      .enter()
      .append("rect")
      .attr("x", (d, i) => i * 30)
      .attr("y", (d, i) => 400 - d[1] * 4)
      .attr("width", 25)
      .attr("height", (d, i) => d[1] * 4)
      // color of the bar dark green if > 50 and red if < 50
      .attr("fill", (d, i) => d[1] > 50 ? "#2F855A" : "#C53030")
      
      // Same chart but with line chart
      d3.select("#reviews-chart")
      .append("svg")
      .attr("width", 600)
      .attr("height", 400)
      .append("g")
      ...
      .append("line")
      .attr("x1", (d, i) => i * 30)
      .attr("y1", (d, i) => 400 - d[1] * 4)
      .attr("x2", (d, i) => i * 30 + 25)
      .attr("y2", (d, i) => 400 - d[1] * 4)
